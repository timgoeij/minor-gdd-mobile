...
public class BigMeteorStorm : LevelPattern
{

    public BigMeteorStorm()
    {
    ...
    public override void init()
    {
        ...
        {
            meteorSpawner.GetComponent<MeteorSpawner>().SpawnMode = MeteorSpawner.MeteorSpawnMode.BigMeteorShower;
